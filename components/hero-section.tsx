      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-lg lg:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 text-balance leading-relaxed">
            AI-powered financial intelligence for African and emerging-market SMEs. Get professional reports, encrypted
            insights, and business clarity — all without exposing your data.
          </p>
